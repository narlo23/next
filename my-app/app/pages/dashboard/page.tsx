                    ...
                    <div className="flex-1 text-main-navy text-xs flex flex-col p-5 min-w-[73rem] max-w-7xl pb-32 pt-8 px-10">
                        ...
                        <div className="grid gap-3 mt-10 md:grid-cols-2 lg:grid-cols-3">
                            <div className="col-span-1 drop-shadow-sm bg-white border p-6 rounded-lg h-[254px] flex flex-col">
                                ...
                                <div className="grid grid-cols-[1fr_2fr]">
                                    ...
                                    <div className="flex self-center mt-3 text-xl font-bold text-gray-500 gap-x-8">
                                        <div>Free 플랜</div>
                                        <ChevronRightIcon width={24} height={24} className="text-gray-300"/>
                                    </div>
                            ...
                            <div className="col-span-2 drop-shadow-sm bg-white border p-6 rounded-lg h-[254px]">
                                ...
                                <div className="flex">
                                    <div className="flex flex-col gap-y-2 w-60 h-40 items-center border-r">
                                        ...
                                        <div>
                                            <Button variant="outlined" className="border-gray-300 bg-white text-xs font-medium text-gray-700 py-[10px] px-[15px] rounded-md hover:border-gray-300 hover:bg-white">추가하기</Button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-y-2 py-9 px-2.5">
                                        ...
                                        <div className="flex gap-x-2 items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="w-8 h-8 text-secondary"><path strokeLinecap="round" strokeLinejoin="round" d="M16.06 10.71h4.41m-2.2 2.21V8.51m-7.63 1.97A3.24 3.24 0 107.4 7.25a3.23 3.23 0 003.24 3.23zm0 2.37c-3.76 0-6.39 1.89-6.39 4.6a.65.65 0 00.3.55c.17.12 1.78 1.14 5.92 1.14 4.29 0 6.14-1.07 6.22-1.11a.68.68 0 00.33-.58c0-2.71-2.63-4.6-6.38-4.6z"></path></svg>
                                            <div>
                                    ...
                                    <div className="flex flex-col gap-y-2 py-9 px-2.5">
                                        ...
                                        <div className="flex gap-x-2 items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 31 31" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="w-8 h-8 text-danger"><path strokeLinecap="round" strokeLinejoin="round" d="M20.262 13.887h5.513M13.488 13.6a4.05 4.05 0 10-4.05-4.037 4.038 4.038 0 004.05 4.037zm0 2.963c-4.7 0-7.988 2.362-7.988 5.75a.813.813 0 00.375.687c.213.15 2.225 1.425 7.4 1.425 5.362 0 7.675-1.338 7.775-1.387a.85.85 0 00.412-.726c0-3.387-3.287-5.75-7.974-5.75z"></path></svg>
                                            <div>
                            ...
                            <div className="flex justify-between col-span-1 drop-shadow-sm bg-white border p-6 rounded-lg h-[254px]"> 
                                ...
                                <button className="h-7 w-7 border rounded-md flex items-center justify-center cursor-pointer" onClick={() => {
                            ...
                            <div className="grid grid-cols-4 gap-y-10 gap-x-3">
                                <div className="w-full mr-4 flex flex-col bg-white shadow h-36 rounded-xl">
                                    <div className="px-6 pt-3 flex flex-1 justify-between items-start">
                                        ...
                                        <img width={36} src="https://dev-org.officenext.net/_next/image?url=https%3A%2F%2Fdev-api.jmember.co.kr%2Fapi%2Fimages%2F417c3f64-4b22-41ee-a852-b4a7767c3277&w=96&q=75"></img>
                                    </div>
                                    <div className="bg-gray-50 px-6 py-2 mt-2 border-t rounded-b-xl flex justify-between items-center">
                                        <div className="cursor-pointer flex items-center text-main-navy" onClick={() => {
                                            window.open("https://jiransoft.gitbook.io/manual/guide/officenext/officewave")
                                        }}>
                                            사용가이드
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" className="w-4 h-3 text-primary"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                        </div>
                                        <Button variant="outlined" className="bg-white w-24 rounded-md text-xs px-[11px] border-gray-300 text-gray-700" onClick={() => {
                                ...
                                <div className="w-full mr-4 flex flex-col bg-white shadow h-36 rounded-xl">
                                    <div className="px-6 pt-3 flex flex-1 justify-between items-start">
                                        ...
                                        <img width={36} src="https://dev-org.officenext.net/_next/image?url=https%3A%2F%2Fdev-api.jmember.co.kr%2Fapi%2Fimages%2Ffa4038bc-54b8-4502-91df-dd8d5d57e757&w=96&q=75"></img>
                                    </div>
                                    <div className="bg-gray-50 px-6 py-2 mt-2 border-t rounded-b-xl flex justify-between items-center">
                                    <div className="cursor-pointer flex items-center text-main-navy" onClick={() => {
                                            window.open("https://jiransoft.gitbook.io/manual/guide/officenext/officewave")
